...
/**
 * {@link FavoriteAdapter} exposes a list of weather forecasts
...
public class FavoriteAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        File internalStorage = mContext.getDir("favoriteDir", Context.MODE_PRIVATE);
        File favoritePath = new File(internalStorage, cursor.getString(FavoriteListFragment.COL_POSTER_PATH));
